 ...
 *********************************/
public class GetEventDetailEvent extends BaseNetworkEvent {

    public static final OnLoadingError FAILED = new OnLoadingError(UNHANDLED_MSG, UNHANDLED_CODE);

    public static class OnLoaded extends OnDone<GetEventDetailResponse> {
        public OnLoaded(GetEventDetailResponse response) {
            super(response);
        }
    }
